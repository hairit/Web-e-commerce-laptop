...
const PRODUCT_OPTIONS = [
    ...
    },
    {
        ...
        path : '',
        icon : () => {return <FcSalesPerformance  className="pro-list-item-icon" />}
    },
    {
        optionName : 'Mua để nhận quà',
        path : '',
        icon : () => {return <AiFillGift className="pro-list-item-icon" id="gift"/>}
    },
    {
        optionName : 'Miễn phí giao hàng',
        path : '',
        icon : () => {return <FcShipped className="pro-list-item-icon" />}
    },
    {
        optionName : 'Hàng chính hãng',
        path : '',
        icon : () => {return <FaMedal className="pro-list-item-icon" id="medal-icon" />}
    }
]
